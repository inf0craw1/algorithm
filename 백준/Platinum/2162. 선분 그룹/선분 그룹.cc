...
bool ChkIsCrossed(pair<pi, pi> line1, pair<pi, pi> line2) {
	...
	//cout << "Common X range point." << xRange.fi << ',' << xRange.se << endl << "| line1: " << line1LeftPoint.fi << ',' << line1LeftPoint.se << ' ' << line1RightPoint.fi << ',' << line1RightPoint.se << endl << "| line2: " << line2LeftPoint.fi << ',' << line2LeftPoint.se << ' ' << line2RightPoint.fi << ',' << line2RightPoint.se << endl;
	...
	if ( line1LeftPoint == line2LeftPoint || line1LeftPoint == line2RightPoint || line1RightPoint == line2LeftPoint || line1RightPoint == line2RightPoint  ) {
		//cout << "Got same point" << endl;
		return true;
	}

	//cout << "line1 : " << line1LeftPoint.fi << ',' << line1LeftPoint.se << ' ' << line1RightPoint.fi << ',' << line1RightPoint.se << endl;
	//cout << "line2 : " << line2LeftPoint.fi << ',' << line2LeftPoint.se << ' ' << line2RightPoint.fi << ',' << line2RightPoint.se << endl;
